namespace ECommerceEnterprise.Pedido.API.Application.DTO;
...
public class PedidoDTO
{
    ...
    public static PedidoDTO ParaPedidoDTO(ECommerceEnterprise.Pedidos.Domain.Pedidos.Pedido pedido) 
    {
