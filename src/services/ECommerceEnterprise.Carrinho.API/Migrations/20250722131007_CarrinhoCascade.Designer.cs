...
namespace ECommerceEnterprise.Carrinho.API.Migrations
{
    ...
    [Migration("20250722131007_CarrinhoCascade")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceEnterprise.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ECommerceEnterprise.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ECommerceEnterprise.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.OwnsOne("ECommerceEnterprise.Carrinho.API.Model.Voucher", "Voucher", b1 =>
                        {
            ...
            modelBuilder.Entity("ECommerceEnterprise.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.HasOne("ECommerceEnterprise.Carrinho.API.Model.CarrinhoCliente", "CarrinhoCliente")
                        .WithMany("Itens")
